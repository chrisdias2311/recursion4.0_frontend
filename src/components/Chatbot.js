...
import { Button, Card, CardContent, Icon, TextField, Typography } from '@mui/material';
...
export default function Chatbot() {
    async function chat() {
        ...
        try {
            const passage = "the catagories are electronics,mobiles and laptops, home and kitchen, fashion and clothing. current offers are '50% off on electornics','20% off on clothing"
    ...
    return (
        <div sx={{ display: 'flex', float: 'right' }}>
            <Card sx={{ Height: '200px', Width: '200px', position: 'sticky', marginLeft: '80vw', marginTop: '70vh', zIndex: 3, border: 'none', borderRadius: 3 }}>
                <CardContent >
                    <Button><Icon><CloseIcon /></Icon></Button>
                    <Box sx={{ minHeight: '50px', bgcolor: 'grey', justifyContent: 'center', display: 'flex', margin: 'none', borderRadius: 1 }}> <Typography sx={{}}></Typography></Box>
